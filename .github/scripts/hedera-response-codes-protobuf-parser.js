...
async function main() {
  const version = (await axios.get('https://raw.githubusercontent.com/hiero-ledger/hiero-consensus-node/refs/heads/main/version.txt')).data.replace('\n', '');
  const res = (await axios.get('https://raw.githubusercontent.com/hiero-ledger/hiero-consensus-node/refs/heads/main/hapi/hedera-protobuf-java-api/src/main/proto/services/response_code.proto')).data;
  ...
  fs.writeFileSync('./contracts/common/HederaResponseCodes.sol', contract);
}
