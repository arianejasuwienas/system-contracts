...
- local for reference and how to setup a local node please follow the [link](https://solo.hiero.org/v0.49.0/docs/step-by-step-guide/)
- testnet
- previewnet
...
- From the root of your project directory, execute the following command to start up a `Hedera local solo node`:
